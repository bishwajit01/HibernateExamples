...
public class HibernateTest {
	...
	private static void fetchingFromDatabase(SessionFactory sessionFactory) {
		...
		do {
			...
			if (null != userDetails) {
				...
				for (Address address : userDetails.getListOfAddress()) {
					System.out.println("House No   :: " + address.getHouseNumber());
	...
	private static SessionFactory savingIntoDataBase() {
		...
		userDetails1.getListOfAddress().add(address1);
		userDetails1.getListOfAddress().add(address2);
		...
		userDetails2.getListOfAddress().add(address2);
		userDetails2.getListOfAddress().add(address1);
